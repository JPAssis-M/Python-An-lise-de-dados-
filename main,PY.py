...
def graficos():
    ...
    graph_html_1 = fig1.to_html(full_hmtl=False, include_plotlyjs='cdn')
    graph_html_2 = fig2.to_html(full_hmtl=False, include_plotlyjs='False')
